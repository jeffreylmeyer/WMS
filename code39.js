/*
 * used to create barcode for pallet labels
 * uses 3"x5" labels (which are folded in half around chicke wire or straps)
 *
 * ConnectCode
 *
 ...
 */
		...
		function DrawCode39Barcode(data,
						   checkDigit,cmw)
		{
			return DrawHTMLBarcode_Code39(data,checkDigit,"yes","cm", 0,cmw,1,3,"bottom","left", "","black","white"); 
		}
						    ...
						    mode)
		{
			  ...
			  if (mode=="html")
			  {
				  ...
				  {
					if (textStyle=='')
						humanSpan='<br /><span style="font-weight:bold;font-family : arial; font-size:12pt">'+humanReadableText+'</span>';
					else
